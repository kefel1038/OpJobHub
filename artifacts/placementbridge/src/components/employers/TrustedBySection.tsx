  ...
  return (
    <section className="py-24 bg-surface relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-blue-400lue-600 font-bold text-sm tracking-widest uppercase mb-4 block">Trusted By Industry Leaders</span>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="bg-elevated rounded-3xl p-8 border border-[#2C2C2E] hover:border-blue-200 transition-all duration-300 card-hover"
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-gray-100 text-sm">{t.author}</div>
