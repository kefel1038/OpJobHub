...
const industries = [
  ...
  { icon: Shield, name: "Security", color: "from-blue-600 to-blue-400", bgColor: "bg-blue-500lue-50", count: "1,800+" },
  ...
  { icon: Monitor, name: "IT & Software", color: "from-blue-500 to-indigo-400", bgColor: "bg-blue-500lue-50", count: "650+" },
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-12">
          {industries.map((industry, i) => (
            <motion.div
              ...
              className="group bg-elevated rounded-2xl p-5 border border-[#2C2C2E] hover:border-blue-200 transition-all duration-300 card-hover cursor-pointer"
            >
              ...
              <h3 className="font-bold text-gray-100 mb-1">{industry.name}</h3>
