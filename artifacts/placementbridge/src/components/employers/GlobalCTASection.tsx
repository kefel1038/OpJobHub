      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-blue-300 font-medium">Start hiring in minutes</span>
          </motion.div>

          <h2 className="text-5xl md:text-7xl font-heading font-black text-white mb-6 leading-[1.05]">
            Ready to build your{" "}
            <span className="text-gradient-electric">global workforce</span>
            ?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button variant="outline" asChild className="border-blue-400/30 text-blue-300 hover:bg-blue-500/10 hover:text-blue-200 rounded-full px-10 h-14 text-lg font-bold">
              <Link href="/contact">
                <MessageSquare className="mr-2 h-5 w-5" />
                Talk to Sales
              </Link>
            </Button>
            <Button variant="ghost" asChild className="text-blue-300 hover:text-white hover:bg-white/5 rounded-full px-8 h-14 text-lg font-medium gap-2">
          ...
          <motion.div
            ...
            className="mt-12 flex items-center justify-center gap-8 text-sm text-blue-300/40"
          >
